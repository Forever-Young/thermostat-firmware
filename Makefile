...
#AVRDUDE_WRITE_FUSES = -U lfuse:w:0xff:m # external crystal 8Mhz

#AVRDUDE_WRITE_FUSES = -U lfuse:w:0x04:m #run with 8 Mhz clock

#AVRDUDE_WRITE_FUSES = -U lfuse:w:0x21:m #run with 1 Mhz clock #default clock mode

#AVRDUDE_WRITE_FUSES = -U lfuse:w:0x01:m #run with 1 Mhz clock no start up time

AVRDUDE_WRITE_FUSES = -U lfuse:w:0xe4:m #run with 8 Mhz Int.RC
